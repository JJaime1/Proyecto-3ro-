...
<body class="BgAzul" style="overflow-y: hidden;">
    <div class="table-container">
			<table class="BgAzul">
				<thead class="BgAzul">
					<tr class="LetraB">
						<th title="Identidicador del cliente">id</th>
						<th title="NOmbre del cliente">Nombre</th>
						<th><button id="agregarCliente" class="btnAgr" style="font-weight: bold;font-family:sans-serif;">Agregar cliente</button></th>
					</tr>
				</thead>
