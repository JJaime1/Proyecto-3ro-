...
<!-- Mostrar info-->	<iframe class="oculto" src="clientesTabla.php"></iframe> <!-- Al darle a un boton para mostrar informacion de algo, cambiar clase a "Mostrar"-->
<!-- Movimientos-->     <iframe class="oculto" src="movimientos.php"></iframe> 
						<iframe class="oculto" src="agregarCliente.php"></iframe> 
