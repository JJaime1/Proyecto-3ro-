...
<body>
    ...
    <div class="dropdown">
        <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"
            id="drop" style="background-color:#354382;">
            Mostrar mas
        </button>
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="#">Lista negra</a></li>
            <li><a class="dropdown-item" href="#">Movimientos</a></li>
            <li><a class="dropdown-item" href="#">Adminstración</a></li>
    ...
    <div class="container-fluid main">
        <div class="menu">
            <ul id="opciones-menu">
                ...
                <li><a href="#">Adminstración</a></li>
                <li><a href="#">Cerrar Sesión</a></li>
            </ul>

        </div>
        <div class="bienvenida"> 
<!--clientes-->			<iframe class="mostrar" src="clientesTabla.php"></iframe> <!-- Al darle a un boton para mostrar informacion de algo, cambiar clase a "Mostrar"-->
<!--Viajes -->			<iframe class="oculto" src="viajesTabla.php"></iframe>
<!-- Movimientos-->     <iframe class="oculto" src="movimientos.php"></iframe> 
